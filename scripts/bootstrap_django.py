...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    try:
        ...
        static_dir = static_root_path or (project_root / "staticfiles")

        print("\n=== Pasos manuales en PythonAnywhere ===")
        print("1. En la pestaña Web, pulsa “Add a new web app” y avanza con “Next” hasta elegir “Manual configuration”.")
        print(f"2. Selecciona Python {python_version_api} (o la versión que uses en tu virtualenv).")
        print(f"3. Source code: {project_root}")
        print(f"4. Working directory: {project_root}")
        print(f"5. Virtualenv: {venv_path}")
        print(f"6. Static files → URL /static/  |  Directory {static_dir}")
        print("7. Activa Force HTTPS si querés forzar el uso de HTTPS.")
        print("8. (Opcional) Configura usuario y contraseña si querés proteger el sitio.")
        print("9. Edita el archivo WSGI para apuntar al proyecto y pulsa Reload.")
